...
| 358 | &emsp;&emsp;&emsp;Voorvoegsels | Patient (<a href="StructureDefinition-ACP-Patient.html">ACPPatient</a>) | `name[nameInformation].family.extension[prefix]`  |
| 359 | &emsp;&emsp;&emsp;Achternaam | Patient (<a href="StructureDefinition-ACP-Patient.html">ACPPatient</a>) | `name[nameInformation].family.extension[lastName]`  |
| 361 | &emsp;&emsp;&emsp;VoorvoegselsPartner | Patient (<a href="StructureDefinition-ACP-Patient.html">ACPPatient</a>) | `name[nameInformation].family.extension[partnerPrefix]`  |
| 362 | &emsp;&emsp;&emsp;AchternaamPartner | Patient (<a href="StructureDefinition-ACP-Patient.html">ACPPatient</a>) | `name[nameInformation].family.extension[partnerLastName]`  |
...
| 365 | &emsp;&emsp;Straat | Patient (<a href="StructureDefinition-ACP-Patient.html">ACPPatient</a>) | `address.line.extension[streetName]`  |
| 366 | &emsp;&emsp;Huisnummer | Patient (<a href="StructureDefinition-ACP-Patient.html">ACPPatient</a>) | `address.line.extension[houseNumber]`  |
| 367 | &emsp;&emsp;Huisnummerletter | Patient (<a href="StructureDefinition-ACP-Patient.html">ACPPatient</a>) | `address.line.extension[houseNumberLetter-houseNumberAddition]`  |
| 368 | &emsp;&emsp;Huisnummertoevoeging | Patient (<a href="StructureDefinition-ACP-Patient.html">ACPPatient</a>) | `address.line.extension[houseNumberLetter-houseNumberAddition]`  |
| 369 | &emsp;&emsp;AanduidingBijNummer | Patient (<a href="StructureDefinition-ACP-Patient.html">ACPPatient</a>) | `address.line.extension[houseNumberIndication]`  |
...
| 373 | &emsp;&emsp;Land | Patient (<a href="StructureDefinition-ACP-Patient.html">ACPPatient</a>) | `address.country.extension[countryCode]`  |
| 374 | &emsp;&emsp;AdditioneleInformatie | Patient (<a href="StructureDefinition-ACP-Patient.html">ACPPatient</a>) | `address.line.extension[additionalInformation]`  |
...
| 381 | &emsp;&emsp;&emsp;Toelichting | Patient (<a href="StructureDefinition-ACP-Patient.html">ACPPatient</a>) | `telecom[telephoneNumbers].extension[comment]`  |
...
| 387 | &emsp;Geslacht | Patient (<a href="StructureDefinition-ACP-Patient.html">ACPPatient</a>) | `gender.extension[genderCodelist]`  |
...
| 761 | Wilsbekwaamheid m.b.t. medische behandelbeslissingen | Observation (<a href="StructureDefinition-ACP-LegallyCapableTreatmentDecisions.html">ACPLegallyCapableTreatmentDecisions</a>) | ``  |
| 762 | &emsp;Wilsbekwaamheid m.b.t. medische behandelbeslissingen | Observation (<a href="StructureDefinition-ACP-LegallyCapableTreatmentDecisions.html">ACPLegallyCapableTreatmentDecisions</a>) | `valueBoolean`  |
| 762 | &emsp;Wilsbekwaamheid m.b.t. medische behandelbeslissingen | Observation (<a href="StructureDefinition-ACP-LegallyCapableTreatmentDecisions.html">ACPLegallyCapableTreatmentDecisions</a>) | `dataAbsentReason`  |
| 763 | &emsp;Toelichting | Observation (<a href="StructureDefinition-ACP-LegallyCapableTreatmentDecisions.html">ACPLegallyCapableTreatmentDecisions</a>) | `note.text`  |
...
| 448 | &emsp;&emsp;&emsp;Voorvoegsels | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `name[nameInformation].family.extension[prefix]`  |
| 449 | &emsp;&emsp;&emsp;Achternaam | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `name[nameInformation].family.extension[lastName]`  |
| 451 | &emsp;&emsp;&emsp;VoorvoegselsPartner | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `name[nameInformation].family.extension[partnerPrefix]`  |
| 452 | &emsp;&emsp;&emsp;AchternaamPartner | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `name[nameInformation].family.extension[partnerLastName]`  |
...
| 457 | &emsp;&emsp;&emsp;TelecomType | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `telecom[telephoneNumbers].system.extension[telecomType]`  |
...
| 459 | &emsp;&emsp;&emsp;Toelichting | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `telecom[telephoneNumbers].extension[comment]`  |
...
| 464 | &emsp;&emsp;Straat | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `address.line.extension[streetName]`  |
| 465 | &emsp;&emsp;Huisnummer | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `address.line.extension[houseNumber]`  |
| 466 | &emsp;&emsp;Huisnummerletter | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `address.line.extension[houseNumberLetter-houseNumberAddition]`  |
| 467 | &emsp;&emsp;Huisnummertoevoeging | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `address.line.extension[houseNumberLetter-houseNumberAddition]`  |
| 468 | &emsp;&emsp;AanduidingBijNummer | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `address.line.extension[houseNumberIndication]`  |
...
| 472 | &emsp;&emsp;Land | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `address.country.extension[countryCode]`  |
| 473 | &emsp;&emsp;AdditioneleInformatie | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `address.line.extension[additionalInformation]`  |
...
| 485 | &emsp;&emsp;&emsp;Voorvoegsels | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `name[nameInformation].family.extension[prefix]`  |
| 486 | &emsp;&emsp;&emsp;Achternaam | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `name[nameInformation].family.extension[lastName]`  |
| 488 | &emsp;&emsp;&emsp;VoorvoegselsPartner | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `name[nameInformation].family.extension[partnerPrefix]`  |
| 489 | &emsp;&emsp;&emsp;AchternaamPartner | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `name[nameInformation].family.extension[partnerLastName]`  |
...
| 494 | &emsp;&emsp;&emsp;TelecomType | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `telecom[telephoneNumbers].system.extension[telecomType]`  |
...
| 496 | &emsp;&emsp;&emsp;Toelichting | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `telecom[telephoneNumbers].extension[comment]`  |
...
| 501 | &emsp;&emsp;Straat | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `address.line.extension[streetName]`  |
| 502 | &emsp;&emsp;Huisnummer | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `address.line.extension[houseNumber]`  |
| 503 | &emsp;&emsp;Huisnummerletter | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `address.line.extension[houseNumberLetter-houseNumberAddition]`  |
| 504 | &emsp;&emsp;Huisnummertoevoeging | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `address.line.extension[houseNumberLetter-houseNumberAddition]`  |
| 505 | &emsp;&emsp;AanduidingBijNummer | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `address.line.extension[houseNumberIndication]`  |
...
| 509 | &emsp;&emsp;Land | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `address.country.extension[countryCode]`  |
| 510 | &emsp;&emsp;AdditioneleInformatie | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `address.line.extension[additionalInformation]`  |
...
| 521 | &emsp;&emsp;&emsp;Voorvoegsels | Patient (<a href="StructureDefinition-ACP-Patient.html">ACPPatient</a>) | `name[nameInformation].family.extension[prefix]`  |
| 522 | &emsp;&emsp;&emsp;Achternaam | Patient (<a href="StructureDefinition-ACP-Patient.html">ACPPatient</a>) | `name[nameInformation].family.extension[lastName]`  |
| 524 | &emsp;&emsp;&emsp;VoorvoegselsPartner | Patient (<a href="StructureDefinition-ACP-Patient.html">ACPPatient</a>) | `name[nameInformation].family.extension[partnerPrefix]`  |
| 525 | &emsp;&emsp;&emsp;AchternaamPartner | Patient (<a href="StructureDefinition-ACP-Patient.html">ACPPatient</a>) | `name[nameInformation].family.extension[partnerLastName]`  |
...
| 561 | &emsp;&emsp;&emsp;Voorvoegsels | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `name[nameInformation].family.extension[prefix]`  |
| 562 | &emsp;&emsp;&emsp;Achternaam | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `name[nameInformation].family.extension[lastName]`  |
| 564 | &emsp;&emsp;&emsp;VoorvoegselsPartner | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `name[nameInformation].family.extension[partnerPrefix]`  |
| 565 | &emsp;&emsp;&emsp;AchternaamPartner | RelatedPerson (<a href="StructureDefinition-ACP-ContactPerson.html">ACPContactPerson</a>) | `name[nameInformation].family.extension[partnerLastName]`  |
...
| 618 | &emsp;Toelichting | Consent (<a href="StructureDefinition-ACP-TreatmentDirective.html">ACPTreatmentDirective</a>) | `extension[comment]`  |
...
| 627 | &emsp;&emsp;Lateraliteit | DeviceUseStatement (<a href="StructureDefinition-ACP-MedicalDevice.html">ACPMedicalDevice</a>) | `bodySite.extension[laterality]`  |
...
| 638 | &emsp;Afspraak uitzetten ICD (BehandelBesluit) | Consent (<a href="StructureDefinition-ACP-TreatmentDirective.html">ACPTreatmentDirective</a>) | `modifierExtension[specificationOther]`  |
...
| 653 | &emsp;Toelichting | Consent (<a href="StructureDefinition-ACP-TreatmentDirective.html">ACPTreatmentDirective</a>) | `extension[comment]`  |
...
| 698 | &emsp;Toelichting | Consent (<a href="StructureDefinition-ACP-AdvanceDirective.html">ACPAdvanceDirective</a>) | `extension[comment]`  |
