...
| [#157](https://github.com/IKNL/PZP-FHIR-R4/issues/157) | Updated CommunicationRequest cardinalities by requiring subject, requester and sender, and adding invariant to ensure request date is present. |
