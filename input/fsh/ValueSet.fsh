...
* $snomed#264362003 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#264362003 ^designation[=].use.display = "Synonym"
* $snomed#264362003 ^designation[=].value = "Home (environment)"
* $snomed#264362003 ^designation[+].language = #en-US
* $snomed#264362003 ^designation[=].use.system = "http://snomed.info/sct"
* $snomed#264362003 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#264362003 ^designation[=].use.display = "Synonym"
* $snomed#264362003 ^designation[=].value = "Home"
* $snomed#264362003 ^designation[+].language = #en-US
* $snomed#264362003 ^designation[=].use.system = "http://snomed.info/sct"
* $snomed#264362003 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#264362003 ^designation[=].use.display = "Synonym"
* $snomed#264362003 ^designation[=].value = "Private home"
* $snomed#264362003 ^designation[+].language = #en-US
* $snomed#264362003 ^designation[=].use.system = "http://snomed.info/sct"
* $snomed#264362003 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#264362003 ^designation[=].use.display = "Synonym"
* $snomed#264362003 ^designation[=].value = "Dwelling"
* $snomed#264362003 ^designation[+].language = #en-US
* $snomed#264362003 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#264362003 ^designation[=].value = "Private dwelling"
* $snomed#264362003 ^designation[+].language = #nl-NL
* $snomed#264362003 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#264362003 ^designation[=].value = "thuis (omgeving)"
* $snomed#264362003 ^designation[+].language = #nl-NL
* $snomed#264362003 ^designation[=].use = $sct#900000000000013009 "Synonym"
...
* $snomed#22232009 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#22232009 ^designation[=].use.display = "Synonym"
* $snomed#22232009 ^designation[=].value = "Hospital (environment)"
* $snomed#22232009 ^designation[+].language = #en-US
* $snomed#22232009 ^designation[=].use.system = "http://snomed.info/sct"
* $snomed#22232009 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#22232009 ^designation[=].use.display = "Synonym"
* $snomed#22232009 ^designation[=].value = "Hospital"
* $snomed#22232009 ^designation[+].language = #nl-NL
* $snomed#22232009 ^designation[=].use.system = "http://snomed.info/sct"
* $snomed#22232009 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#22232009 ^designation[=].use.display = "Synonym"
* $snomed#22232009 ^designation[=].value = "ziekenhuis (omgeving)"
* $snomed#22232009 ^designation[+].language = #nl-NL
* $snomed#22232009 ^designation[=].use.system = "http://snomed.info/sct"
* $snomed#22232009 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#22232009 ^designation[=].use.display = "Synonym"
...
* $snomed#108344006 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#108344006 ^designation[=].use.display = "Synonym"
* $snomed#108344006 ^designation[=].value = "Nursing home AND/OR ambulatory care site (environment)"
* $snomed#108344006 ^designation[+].language = #en-US
* $snomed#108344006 ^designation[=].use.system = "http://snomed.info/sct"
* $snomed#108344006 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#108344006 ^designation[=].use.display = "Synonym"
* $snomed#108344006 ^designation[=].value = "Nursing home AND/OR ambulatory care site"
* $snomed#108344006 ^designation[+].language = #nl-NL
* $snomed#108344006 ^designation[=].use.system = "http://snomed.info/sct"
* $snomed#108344006 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#108344006 ^designation[=].use.display = "Synonym"
* $snomed#108344006 ^designation[=].value = "verpleeghuis en/of locatie voor ambulante zorg (omgeving)"
* $snomed#108344006 ^designation[+].language = #nl-NL
* $snomed#108344006 ^designation[=].use.system = "http://snomed.info/sct"
* $snomed#108344006 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#108344006 ^designation[=].use.display = "Synonym"
...
* $snomed#284546000 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#284546000 ^designation[=].value = "Hospice (environment)"
* $snomed#284546000 ^designation[+].language = #en-US
* $snomed#284546000 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#284546000 ^designation[=].value = "Hospice"
* $snomed#284546000 ^designation[+].language = #nl-NL
* $snomed#284546000 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#284546000 ^designation[=].value = "hospice (omgeving)"
* $snomed#284546000 ^designation[+].language = #nl-NL
* $snomed#284546000 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#284546000 ^designation[=].value = "hospice"
...
* $v3-NullFlavor#UNK ^designation.use = $sct#900000000000013009 "Synonym"
...
* $snomed#400231000146108 ^designation[=].use = $sct#900000000000013009 "Synonym"
...
* $snomed#373066001 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#373066001 ^designation[=].use.display = "Synonym"
* $snomed#373066001 ^designation[=].value = "Yes (qualifier value)"
* $snomed#373066001 ^designation[+].language = #en-US
* $snomed#373066001 ^designation[=].use.system = "http://snomed.info/sct"
* $snomed#373066001 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#373066001 ^designation[=].use.display = "Synonym"
* $snomed#373066001 ^designation[=].value = "Yes (qualifier value)"
* $snomed#373066001 ^designation[+].language = #en-UK
* $snomed#373066001 ^designation[=].use.system = "http://snomed.info/sct"
* $snomed#373066001 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#373066001 ^designation[=].use.display = "Synonym"
* $snomed#373066001 ^designation[=].value = "Yes"
* $snomed#373066001 ^designation[+].language = #en-US
* $snomed#373066001 ^designation[=].use.system = "http://snomed.info/sct"
* $snomed#373066001 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#373066001 ^designation[=].use.display = "Synonym"
* $snomed#373066001 ^designation[=].value = "Yes"
* $snomed#373066001 ^designation[+].language = #nl-NL
* $snomed#373066001 ^designation[=].use.system = "http://snomed.info/sct"
* $snomed#373066001 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#373066001 ^designation[=].use.display = "Synonym"
* $snomed#373066001 ^designation[=].value = "ja (kwalificatiewaarde)"
* $snomed#373066001 ^designation[+].language = #nl-NL
* $snomed#373066001 ^designation[=].use.system = "http://snomed.info/sct"
* $snomed#373066001 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#373066001 ^designation[=].use.display = "Synonym"
* $snomed#373066001 ^designation[=].value = "ja"
* $snomed#373066001 ^designation[+].language = #nl-NL
* $snomed#373066001 ^designation[=].use.system = "http://snomed.info/sct"
* $snomed#373066001 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#373066001 ^designation[=].use.display = "Synonym"
...
* $snomed#373067005 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#373067005 ^designation[=].value = "No (qualifier value)"
* $snomed#373067005 ^designation[+].language = #en-US
* $snomed#373067005 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#373067005 ^designation[=].value = "No (qualifier value)"
* $snomed#373067005 ^designation[+].language = #en-UK
* $snomed#373067005 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#373067005 ^designation[=].value = "No"
* $snomed#373067005 ^designation[+].language = #en-US
* $snomed#373067005 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#373067005 ^designation[=].value = "No"
* $snomed#373067005 ^designation[+].language = #nl-NL
* $snomed#373067005 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#373067005 ^designation[=].value = "nee (kwalificatiewaarde)"
* $snomed#373067005 ^designation[+].language = #nl-NL
* $snomed#373067005 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#373067005 ^designation[=].value = "nee"
* $snomed#373067005 ^designation[+].language = #nl-NL
* $snomed#373067005 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#373067005 ^designation[=].value = "geen"
* $snomed#373067005 ^designation[+].language = #nl-NL
* $snomed#373067005 ^designation[=].use = $sct#900000000000013009 "Synonym"
* $snomed#373067005 ^designation[=].value = "ontkenning"
* $snomed#373067005 ^designation[+].language = #nl-NL
* $snomed#373067005 ^designation[=].use = $sct#900000000000013009 "Synonym"
