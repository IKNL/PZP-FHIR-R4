...
Usage: #example
// shouldn't this one have an identifier too?
* status = #final
* code =  $snomed#153851000146100 // Why code needed as it is a fixed value?
...
* method = $snomed#370819000 "vaststellen van persoonlijke waarden en wensen met betrekking tot zorg (verrichting)" // Why code needed as it is a fixed value?
...
* status = #final
* code =  $snomed#395091006 // Why code needed as it is a fixed value?
* subject = Reference(P1-ACP-Patient-HendrikHartman) "Patient, Hendrik Hartman"
* encounter = Reference(P1-ACP-Encounter-29-07-2025) "Encounter, 2025-07-29"
* effectiveDateTime = "2025-07-29"
* performer = Reference(P1-ACP-HealthProfessional-PractitionerRole-DrVanHuissen) "Healthcare professional (role), van Huissen"
...
* status = #final
* code =  $snomed#340171000146104 // Why code needed as it is a fixed value?
* subject = Reference(P1-ACP-Patient-HendrikHartman) "Patient, Hendrik Hartman"
* encounter = Reference(P1-ACP-Encounter-29-07-2025) "Encounter, 2025-07-29"
* effectiveDateTime = "2025-07-29"
* performer = Reference(P1-ACP-HealthProfessional-PractitionerRole-DrVanHuissen) "Healthcare professional (role), van Huissen"
* valueCodeableConcept = $snomed#340201000146103 "Wenst geen euthanasie" // Is this display required or not?
...
* status = #final
* code = $snomed#570801000146104 "geregistreerd in orgaan donorregister (bevinding)" // Why code needed as it is a fixed value?
* subject = Reference(P1-ACP-Patient-HendrikHartman) "Patient, Hendrik Hartman"
* encounter = Reference(P1-ACP-Encounter-29-07-2025) "Encounter, 2025-07-29"
* effectiveDateTime = "2025-07-29"
* performer = Reference(P1-ACP-HealthProfessional-PractitionerRole-DrVanHuissen) "Healthcare professional (role), van Huissen"
...
* status = #final
* code =  $snomed#247751003 // Why code needed as it is a fixed value?
* subject = Reference(P1-ACP-Patient-HendrikHartman) "Patient, Hendrik Hartman"
* encounter = Reference(P1-ACP-Encounter-29-07-2025) "Encounter, 2025-07-29"
* effectiveDateTime = "2025-07-29"
* performer = Reference(P1-ACP-HealthProfessional-PractitionerRole-DrVanHuissen) "Healthcare professional (role), van Huissen"
