...
Instance: P1-ACP-HealthProfessional2-PractitionerRole-Santos
InstanceOf: ACPHealthProfessionalPractitionerRole
Title: "P1 ACP HealthProfessional2 PractitionerRole Santos"
Usage: #example
* identifier.type = $v2-0203#RI "Resource identifier"
* identifier.system = "https://acme.com/fhir/NamingSystem/resource-business-identifier"
* identifier.value = "cdafd4b4-47ff-4e04-9f99-51f922b05152"
* practitioner = Reference(P1-ACP-HealthProfessional2-Practitioner-Santos) "Healthcare professional (person), Santos"
* practitioner.type = "Practitioner"
