...
Instance: ACP-HealthProfessionalPractitionerRole-DesireeWolters-Pat2
...
* practitioner = Reference(ACP-HealthProfessionalPractitioner-DesireeWolters-Pat2) "Healthcare professional (person), Desiree Wolters"
* practitioner.type = "Practitioner"
* specialty.coding.version = "2020-10-23T00:00:00"
* specialty.coding = urn:oid:2.16.840.1.113883.2.4.6.7#0100 "Huisartsen, niet nader gespecificeerd"


Instance: ACP-HealthProfessionalPractitionerRole-Santos-Pat2
InstanceOf: ACPHealthProfessionalPractitionerRole
...
* practitioner = Reference(ACP-HealthProfessionalPractitioner-Santos-Pat2) "Healthcare professional (person), Santos"
* practitioner.type = "Practitioner"