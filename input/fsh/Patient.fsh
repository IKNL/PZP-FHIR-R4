...
* insert ObligationRulesInsertWithExtensionLocation(telecom[telephoneNumbers].system.extension[telecomType], 2)   
* insert ObligationRules(telecom[telephoneNumbers].use)
* insert ObligationRulesInsertWithExtensionLocation(telecom[telephoneNumbers].extension[comment], 2)
...
* insert ObligationRulesInsertWithExtensionLocation(gender.extension[genderCodelist], 2)   
...
* insert ObligationRulesInsertWithExtensionLocation(address.country.extension[countryCode], 2)
